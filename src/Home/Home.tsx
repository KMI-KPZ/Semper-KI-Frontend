...
export const Home = () => {
    ...
    const handleClickSearch = (e:React.MouseEvent<HTMLDivElement, MouseEvent>):void => {
      e.preventDefault();
    ...
    const handleClickUpload = (e:React.MouseEvent<HTMLDivElement, MouseEvent>):void => {
      e.preventDefault();
      navigate("/Process/Model/Upload");
    }

    const handleFocusSearch = (e: React.FocusEvent<HTMLInputElement, Element>) => {
      e.preventDefault();
    ...
    return(
        <div className="container flex-container column">
            ...
            <img className="workflow-img" src={require("../images/workflow.png")} alt="3D-Print Work Flow"/>
        </div>
    );
}