    ...
    <div className="process-content-container">
      <div className="catalog-container">
        <div className="user-input">
          <input type="text" className="input-field" placeholder={t('model.catalog.search-placeholder')} autoFocus/>
          <div className="settings button light"><SettingsIcon/></div>
          <div className="search button dark"><SearchIcon/></div>
        </div>
        {modelLoadingError &&
          <div>{t('model.catalog.loading-error')}
            <br/>{t('model.catalog.error-name')}{modelLoadingError.message}
          </div>
        }
        {(modelIsLoading || !modelList) && !modelLoadingError && <div>{t('model.catalog.loading-models')}</div>}
