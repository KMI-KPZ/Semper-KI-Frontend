        ...
        followSelectionMenuList: [
          {
            name:"Folge-Auswahl",
            selectionList: [
              {name:"Folge SelectOption 1",value:"1",price:0,unit:"(E)"},
              {name:"Folge SelectOption 2",value:"2",price:0,unit:"(E)"},
              {name:"Folge SelectOption 3",value:"3",price:0,unit:"(E)"}
            ],
          }
        ]
      }
