...
const HeaderInvoice: React.FC<HeaderInvoiceProps> = (props) => {
  ...
  return (
    <Container
      className="card absolute left-0 top-20 z-40 gap-3 bg-white"
      direction="col"
      justify="start"
      align="center"
      width="fit"
    >
      <Container width="full" direction="row" justify="between" className="">
        <Heading variant="h2">
        ...
        <>
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <Text>"{event.eventData.content}"</Text>
