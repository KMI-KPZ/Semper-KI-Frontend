...
} from "@/pages/Resources/components/NodeForm";
import ResourcesNodeDraft from "@/pages/Resources/components/NodeDraft";
import ResourcesPropertyForm from "@/pages/Resources/components/PropertyForm";
import ResourcesEdgeForm from "@/pages/Resources/components/EdgeForm";
import useCreateAdminNode from "@/api/Resources/Admin/Mutations/useCreateAdminNode";
import useUpdateAdminNode from "@/api/Resources/Admin/Mutations/useUpdateAdminNode";

interface AdminResourcesNodePropsForm {
...
const AdminResourcesNodeForm: React.FC<AdminResourcesNodePropsForm> = (
  props
) => {
  const { type, nodeType, nodeProperties, node, edges } = props;
  const { t } = useTranslation();
  const createOrgaNode = useCreateAdminNode();
  const updateOrgaNode = useUpdateAdminNode();
...
export default AdminResourcesNodeForm;
