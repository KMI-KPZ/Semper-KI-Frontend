...
const DemonstratorPage1: React.FC<Props> = (props) => {
    ...
    return (
        <main className="flex h-full w-full flex-grow flex-row-reverse items-left justify-start">
            <div
                className={"flex h-full w-8/12 min-w-[900] flex-col items-center justify-center p-3  md:flex-row bg-yellow-400"}>
                <PlayForm data={"testdatastring"}/>
            </div>
            <div
                className={"flex h-full w-4/12 max-w-7xl flex-col items-center justify-center p-3 md:flex-row bg-green-500"}>
