...
interface HomeAnonymOrgaProps {}

const HomeAnonymOrga: React.FC<HomeAnonymOrgaProps> = (props) => {
  const {} = props;
    ...
    >
      <div className="flex w-full max-w-4xl flex-col gap-5 md:flex-row md:justify-between md:gap-40">
        <div className="flex flex-col items-start justify-center gap-5">
          <Heading variant="h2">{t("Home.Home.Anonym.Orga.title")}</Heading>
          <Heading variant="subtitle" className="pl-5">
            {t("Home.Home.Anonym.Orga.subTitle")}
          </Heading>
        </div>
