...
const ResourcesPrintersAdd: React.FC<ResourcesPrintersAddProps> = (props) => {
  ...
  //               printer.title
  //                 .toLocaleLowerCase()
  //                 .includes(watch("printerName").toLocaleLowerCase())
  //             )
  //             .map((printer, index) => (
  //               <div
  //                 key={index}
            ...
            {editPrinter ? (
              <>
                    ...
                    ? watch(`properties.${propertyIndex}.values`)?.map(
                        (title, valueIndex) => (
                          ...
                          >
                            ...
                            <Button
                              title={t(
                                "Resources.Printers.form.button.removeValue"
                              )}
                              onClick={() =>
                ...
                <Button
                  ...
                  onClick={() =>
                    handleOnClickButtonRemoveProperty(propertyIndex)
                  }
                />
              </>
            ) : (
              <div className="flex flex-row items-start justify-around gap-5">
                <Text variant="body">
                  {prop.name === "" ? "---" : prop.name}
                </Text>
